Module Module1
    Public partcal_effect(300) As partcle	'粒子特效物件庫
    Public Me_Attack(100) As partcle		'粒子特效物件庫
    Public Enemy_Attack(100) As partcle		'粒子特效物件庫
    Public Enemy_Obj(100) As enemy			'粒子特效物件庫
    Public attack As Boolean				'攻擊？
    Public attack_CD(20) As Integer			'技能冷卻計數器
    Public attack_ammo(20) As Integer
    Public level_count As Integer			'關卡計數器

    Public player_HP As Integer				'玩家血量
    Public Player_loc As Point				'玩家位置
    '創建粒子飛濺特效	particle_effect_create(size,x,y,speed,count,number,color)
    ...
    '創造敵人攻擊彈幕 particle_attack_create(type,x,y,speed,th,color,attack)
    ...
    '創造敵人 enemy_create(type  hp , color , size , loc)
