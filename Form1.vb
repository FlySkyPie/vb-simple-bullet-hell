Public Class Form1
    ...
    Private Sub Form1_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        If e.KeyValue = Keys.Escape Then		'離開遊戲
            shutdown_QAQ()
            '10ms /1 count   1sec/100count
        ElseIf e.KeyValue = Keys.Z Then			'技能鍵-導彈
            If attack_CD(2) = 0 Then			'技能冷卻結束
                attack_CD(2) = 500				'重設冷卻時間
                Dim j As Integer
                For j = 1 To 3
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '初始化========================
        Cursor.Hide()							'隱藏Windows鼠標
        PictureBox1.Size = Me.Size				'重設VB繪圖控件
        player_HP = 100							'設定血量
    ...
    Private Sub Timer_Draw_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_Draw.Tick
        ...
        PictureBox1.Image = map		'把剛剛繪製完的圖貼到PictureBox裡面
    End Sub
    ...
    Private Sub Form1_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        Timer1.Enabled = True				'關閉Timer
        Timer_Draw.Enabled = True			'關閉Timer
        Timer3.Enabled = True				'關閉Timer
        Timer_Level_Counter.Enabled = True	'關閉Timer
